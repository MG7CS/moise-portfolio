...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Moise Gasana</h2>;
  const three = (
    <h3 className="big-heading">I build software that solves real problems for real people.</h3>
  );
  const four = (
    <>
      <p>
        Full-stack engineer and CS senior at{' '}
        ...
        . Brown Venture Prize 2025 Finalist.
      </p>
    </>
  );
  const five = (
